...
def test_viterbi_forward(target, A, B, test_corpus, vocab):
    ...
    best_paths_shape = (46, 34199)
    best_paths_initialized = np.zeros(best_paths_shape, dtype=np.int64)
    best_probs_initialized = np.array([[-22.60982633354825 , -23.076606538949925, -23.572988219423895,
                                        -19.767260659757056, -24.743251039022525, -35.202414015896515,
                                        -35.000960243479796, -34.99203853835508 , -21.35069072298156 ,
                                        -19.857678139073787, -21.920984144532607,  -4.016237413730867,
                                        -19.163805931843697, -21.106224196237005, -20.471639731656758,
                                        -21.101572732591492, -21.49584851128058 , -20.481185296429818,
                                        -18.258563069919184, -23.397174705321632, -21.921467981837463,
                                         -9.413777771736614, -21.030534446796068, -21.080295913742766,
                                        -20.108636769220784, -33.48185978914074 , -19.47301381537457 ,
                                        -20.77150241893191 , -20.117276956009565, -20.56031676244655 ,
                                        -20.571939635396273, -32.30366295168992 , -18.075515217248487,
                                        -22.588879090408   , -19.158590498930838, -16.029943312249273,
                                        -24.309685450632625, -20.92932217612084 , -21.967972219183945,
                                        -24.295718951607533, -23.45968568673026 , -22.43665882558586 ,
                                        -20.46568903600152 , -22.755516060499776, -19.663721498628966,
                                        -18.362884631634696]], dtype=np.float64)
    best_probs_initialized = np.concatenate([best_probs_initialized.T,
                                             np.zeros((best_paths_shape[0], best_paths_shape[1] - 1))], axis=1)
    ...
    test_cases = [
        {
            ...
            "input": {
                ...
                "best_probs": best_probs_initialized,
                "best_paths": best_paths_initialized,
                "vocab": vocab,
                "verbose": False,
            },
            "expected": {
    ...
    test_cases = [
        {
            ...
            "input": {
                ...
                "best_probs": pickle.load(
                    open("./support_files/best_probs.pkl", "rb")
                ),
                "best_paths": pickle.load(
                    open("./support_files/best_paths.pkl", "rb")
                ),
                "states": states,
            },
            "expected": {
